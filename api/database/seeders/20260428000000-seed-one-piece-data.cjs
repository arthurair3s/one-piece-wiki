...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('islands', [
      ...
      { id: 3, name: 'Orange Town', description: 'Cidade dominada por Buggy.', coordinate_x: 44.9, coordinate_y: 39.6, coordinate_z: 0, rotation_y: -180.0, scale: 1.00, model_url: '', thumbnail_url: 'https://images.grandline.com/thumbnails/orange-town.png', is_active: true, createdAt: now, updatedAt: now },
      { id: 4, name: 'Ilha Gecko', description: 'Terra natal de Usopp.', coordinate_x: 16.0, coordinate_y: 37.5, coordinate_z: 0, rotation_y: -180.0, scale: 1.00, model_url: '', thumbnail_url: 'https://images.grandline.com/thumbnails/syrup.png', is_active: true, createdAt: now, updatedAt: now },
      { id: 5, name: 'Baratie', description: 'O famoso restaurante flutuante.', coordinate_x: 4.3, coordinate_y: 81.0, coordinate_z: 0, rotation_y: -180.0, scale: 1.00, model_url: '', thumbnail_url: 'https://images.grandline.com/thumbnails/baratie.png', is_active: true, createdAt: now, updatedAt: now }
    ], { ignoreDuplicates: true });
