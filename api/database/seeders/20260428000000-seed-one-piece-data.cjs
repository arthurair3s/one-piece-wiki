...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('islands', [
      { id: 1, name: 'Vila Foosha', description: 'Ilha natal de Luffy.', coordinate_x: 89.3, coordinate_y: 35.9, coordinate_z: 0, model_url: 'models/foosha.gltf', thumbnail_url: 'https://images.grandline.com/thumbnails/foosha.png', is_active: true, createdAt: now, updatedAt: now },
      { id: 2, name: 'Shells Town', description: 'Base da Marinha comandada por Morgan.', coordinate_x: 65.2, coordinate_y: 9.1, coordinate_z: 0, model_url: 'models/shells-town.gltf', thumbnail_url: 'https://images.grandline.com/thumbnails/shells-town.png', is_active: true, createdAt: now, updatedAt: now },
